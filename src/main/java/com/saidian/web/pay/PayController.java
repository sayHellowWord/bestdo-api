...
public class PayController {
    ...
    public Object payBank(String order_id, String goods_id, String desc, String amount,
                          String channel_id, String appid, String time_expir, String openid) throws Exception {
...
*/
        ResultBean resultBean = null;if ("ALIPAYWAP".equals(channel_id)) {
   ...
   /*     ResultBean resultBean =  payService.payBank(HttpParams.mid, "10w917011716304280", "522160521120318tRS", "10205221000001",
                "调用支付", 5000, "ALIPAYWAP", "10.14.22.75", "",
                300, "", "");*/

     /*   payService.payBank(HttpParams.mid, "10w917011716304280", "522160521120318tRS", "10205221000001",
                "调用支付", 5000, "WEIXINJSAPI", "10.14.22.75", "wx1d30dc3cd2adc80c",
                300, "WEIXINJSAPI", "");*/
        return resultBean;
    }
    ...
    public String payFailPage(String order_id, ModelMap modelMap) {
        System.out.println("========    payFailPage     ====" + order_id);
        modelMap.addAttribute("order_id", order_id);
