    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide" style="background-image: url(../images/bg1.png);">
                <a href="" style="display:block;height:100%;z-index:9999;"></a>
            </div>
...
<!--分类-->
<div class="sportitem font13">
    <div class="sportitemcont www2">
        <div><a href="../site/index" class="i1"><span class="iconfont font16"></span><i></i>场馆预定</a></div>
        <div><a href="#" class="i2"><span class="iconfont font16"></span><i></i>十分钟健身圈</a></div>
        <div><a href="#" class="i3"><span class="iconfont font16"></span><i></i>体育赛事</a></div>
        <div><a href="#" class="i4"><span class="iconfont font16"></span><i></i>体育培训</a></div>
...
<div id="nav">
    <div class="nav font12">
        <div class="navCont box">
            ...
            <a href="javascript:void(0)" class="boxflex"><span></span>我的</a>
        </div>
    </div>
</div>
