    ...
    <#if goodsTypes?? >
        <#list goodsTypes as goodsType>
            <#if goodsType_index == 0  >
                <a href="javascript:void(0)" class="on" data-merid="${goodsType.merid}">${goodsType.client_name}</a>
            <#else >
                <a href="javascript:void(0)" data-merid="${goodsType.merid}">${goodsType.client_name}</a>
            </#if>
        </#list>
    </#if>
    </div>
...
<div id="nav">
    <div class="nav font12">
        <div class="navCont box">
            ...
            <a href="/odds/index" class="boxflex  on"><span></span>特惠</a>
