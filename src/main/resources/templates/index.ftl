	...
	<div class="lunbo">
		<div class="swiper-container">
		    <div class="swiper-wrapper">
		        <div class="swiper-slide" style="background-image: url(images/bg4.jpg);"><a href="" style="display:block;height:100%;z-index:9999;"></a></div>
		        <div class="swiper-slide" style="background-image: url(images/bg1.jpg);"><a href="" style="display:block;height:100%;z-index:9999;"></a></div>
		        <div class="swiper-slide" style="background-image: url(images/bg3.jpg);"><a href="" style="display:block;height:100%;z-index:9999;"></a></div>
		        <div class="swiper-slide" style="background-image: url(images/bg2.jpg);"><a href="" style="display:block;height:100%;z-index:9999;"></a></div>
		        <div class="swiper-slide" style="background-image: url(images/bg5.jpg);"><a href="" style="display:block;height:100%;z-index:9999;"></a></div>
		    </div>
		    <!-- 如果需要分页器 -->
